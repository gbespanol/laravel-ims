                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3">'
                            ...
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('password.email') }}">
                                ...
                                Forgot your password?<strong> No Problem.</strong><strong> Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.</strong>
